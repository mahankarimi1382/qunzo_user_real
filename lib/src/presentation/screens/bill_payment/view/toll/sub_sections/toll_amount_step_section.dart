...
class TollAmountStepSection extends StatelessWidget {
  const TollAmountStepSection({super.key});
            ...
            child: Column(
              children: [
                ...
                CommonRequiredLabelAndDynamicField(
                  labelText: localization!.tollCountryLabel,
                      ...
                      onTap: () {
                        Get.bottomSheet(
                          CommonDropdownBottomSheet(
                            isShowTitle: true,
                            title: localization.tollCountrySelectTitle,
                            ...
                            notFoundText: localization.tollCountryNotFound,
                          ),
                        );
                      },
                      hintText: localization.tollCountryHint,
                ...
                CommonRequiredLabelAndDynamicField(
                  labelText: localization.tollServiceLabel,
                  isLabelRequired: true,
                  dynamicField: Obx(
                    () => CommonTextInputField(
                      suffixIcon: Image.asset(PngAssets.arrowDownCommonIcon),
                      ...
                      onTap: () {
                        Get.bottomSheet(
                          CommonDropdownBottomSheetThree<PayBillServiceData>(
                            ...
                            bottomSheetHeight: 400.h,
                            isShowTitle: true,
                            title: localization.tollServiceSelectTitle,
                            notFoundText: localization.tollServiceNotFound,
                      ...
                      hintText: localization.tollServiceHint,
                ...
                Obx(() {
                  ...
                  return CommonRequiredLabelAndDynamicField(
                    labelText: localization.tollAmountLabel,
                    isLabelRequired: true,
                ...
                CommonButton(
                  text: localization.tollPayButton,
                  onPressed: () {
