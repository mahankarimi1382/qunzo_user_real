    ...
    return SingleChildScrollView(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              localization!.dataBundleReviewTitle,
              style: TextStyle(
                letterSpacing: 0,
                ...
                children: [
                  Obx(
                    () => _buildReviewDynamicContent(
                      context,
                      title: localization.dataBundleReviewAmountLabel,
                      content:
                  ...
                  Obx(
                    () => _buildReviewDynamicContent(
                      context,
                      title: localization.dataBundleReviewChargeLabel,
                  ...
                  Obx(
                    () => _buildReviewDynamicContent(
                      context,
                      title: localization.dataBundleReviewConversionRateLabel,
                  ...
                  Obx(() {
                    ...
                    return _buildReviewDynamicContent(
                      context,
                      title: localization.dataBundleReviewPayableAmountLabel,
                      content: payableText,
                      contentColor: AppColors.lightTextPrimary,
                    );
                  }),
              ...
              children: [
                Expanded(
                  child: CommonIconButton(
                    ...
                    height: 52,
                    text: localization.dataBundleReviewBackButton,
                ...
                Expanded(
                  child: CommonIconButton(
                    ...
                    width: double.infinity,
                    height: 52,
                    text: localization.dataBundleReviewConfirmButton,
