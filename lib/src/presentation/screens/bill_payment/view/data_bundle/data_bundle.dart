...
import 'package:qunzo_user/src/presentation/screens/bill_payment/view/data_bundle/sub_sections/data_bundle_amount_step_section.dart';
import 'package:qunzo_user/src/presentation/screens/bill_payment/view/data_bundle/sub_sections/data_bundle_review_step_section.dart';
        ...
        children: [
          Column(
            children: [
                ...
                () => Visibility(
                  ...
                  child: Column(
                    children: [
                      ...
                      CommonAppBar(
                        title: AppLocalizations.of(context)!.dataBundleTitle,
                      ),
              ...
              Obx(
                () => controller.currentStep.value == 0
                    ? DataBundleAmountStepSection()
                    : controller.currentStep.value == 1
                    ? DataBundleReviewStepSection()
                    : SizedBox(),
              ),
            ],
          ),
