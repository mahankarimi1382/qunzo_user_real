...
class ElectricityReviewStepSection extends StatelessWidget {
  const ElectricityReviewStepSection({super.key});
    ...
    return SingleChildScrollView(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              localization!.electricityReviewTitle,
              style: TextStyle(
                letterSpacing: 0,
                ...
                children: [
                  Obx(
                    () => _buildReviewDynamicContent(
                      context,
                      title: localization.electricityReviewAmountLabel,
                      content:
                  ...
                  Obx(
                    () => _buildReviewDynamicContent(
                      context,
                      title: localization.electricityReviewChargeLabel,
                  ...
                  Obx(
                    () => _buildReviewDynamicContent(
                      context,
                      title: localization.electricityReviewConversionRateLabel,
                  ...
                  Obx(() {
                    ...
                    return _buildReviewDynamicContent(
                      context,
                      title: localization.electricityReviewPayableAmountLabel,
                      content: payableText,
                      contentColor: AppColors.lightTextPrimary,
                    );
                  }),
              ...
              children: [
                Expanded(
                  child: CommonIconButton(
                    ...
                    height: 52,
                    text: localization.electricityReviewBackButton,
                ...
                Expanded(
                  child: CommonIconButton(
                    ...
                    width: double.infinity,
                    height: 52,
                    text: localization.electricityReviewConfirmButton,
