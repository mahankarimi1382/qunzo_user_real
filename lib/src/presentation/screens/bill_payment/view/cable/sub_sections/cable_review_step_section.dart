...
class CableReviewStepSection extends StatelessWidget {
  const CableReviewStepSection({super.key});
                ...
                children: [
                  Obx(
                    () => _buildReviewDynamicContent(
                      context,
                      title: localization.cableReviewAmountLabel,
                      content:
                  ...
                  Obx(
                    () => _buildReviewDynamicContent(
                      context,
                      title: localization.cableReviewChargeLabel,
                  ...
                  Obx(
                    () => _buildReviewDynamicContent(
                      context,
                      title: localization.cableReviewConversionRateLabel,
                  ...
                  Obx(() {
                    ...
                    return _buildReviewDynamicContent(
                      context,
                      title: localization.cableReviewPayableAmountLabel,
                      content: payableText,
                      contentColor: AppColors.lightTextPrimary,
                    );
                  }),
              ...
              children: [
                Expanded(
                  child: CommonIconButton(
                    ...
                    height: 52,
                    text: localization.cableReviewBackButton,
                ...
                Expanded(
                  child: CommonIconButton(
                    ...
                    width: double.infinity,
                    height: 52,
                    text: localization.cableReviewConfirmButton,
