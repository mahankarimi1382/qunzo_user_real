...
class CreateGiftWalletSection extends StatelessWidget {
  const CreateGiftWalletSection({super.key});
        ...
        onTap: () {
          Get.bottomSheet(
            CommonDropdownWalletBottomSheet(
              notFoundText: localizations.createGiftWalletWalletsNotFound,
              dropdownItems: controller.giftWalletsList,
              bottomSheetHeight: 450,
              currentlySelectedValue: controller.wallet.value!.name,
              onItemSelected: (value) async {
                final selectedWallet = controller.giftWalletsList.firstWhere(
                  (w) => w.name == value,
                );
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              Text(
                localizations.createGiftWalletBalance,
                style: TextStyle(
                  letterSpacing: 0,
                  fontWeight: FontWeight.w700,
                  fontSize: 16,
