class P2PMarketPlaceResponseModel {
  String? status;
  String? message;
  Data? data;

  P2PMarketPlaceResponseModel({this.status, this.message, this.data});

  factory P2PMarketPlaceResponseModel.fromJson(Map<String, dynamic> json) =>
      P2PMarketPlaceResponseModel(
        status: json["status"],
