class RequestMoneyHistoryModel {
  String? status;
  String? message;
  RequestMoneyHistoryData? data;

  RequestMoneyHistoryModel({this.status, this.message, this.data});

  RequestMoneyHistoryModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    data = json['data'] != null
        ? RequestMoneyHistoryData.fromJson(json['data'])
        : null;
  }
}

class RequestMoneyHistoryData {
  List<Requests>? requests;
  Pagination? pagination;

  RequestMoneyHistoryData({this.requests, this.pagination});

  RequestMoneyHistoryData.fromJson(Map<String, dynamic> json) {
